...
var cjurl = $.getdata(lotteryurl);
var cjheader = $.getdata(lotterycookie);
var time = new Date().getTime();

var cjurlsend = cjurl.replace(new RegExp("time=.*?&"), "time=" + time + "&");
...
function golottery() {
  return new Promise(resolve => {
    ...
    $.get(lotteryRequest, (error, response, data) => {
